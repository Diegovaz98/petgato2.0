...
insert into Enderecos (id, cep, complemento, rua, pais, estado, cidade, bairro)
values 
...
insert into Voluntarios (CPF, nome, RG, data_nasc, genero, id_endereco, email, senha)
values
...
insert into Voluntarios(CPF, nome, RG, data_nasc, genero, id_endereco, email, senha, foto) values
...
select foto from Voluntarios where CPF = "28709861143";
delete from Voluntarios where CPF = "28709861143";